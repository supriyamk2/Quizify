...
service_account_path = '/Users/supriyamk/Desktop/mission-quizify/authentication.json'
credentials = service_account.Credentials.from_service_account_file(service_account_path)

# Explicitly pass credentials when initializing the client
aiplatform.init(credentials=credentials, project='gemini-quizify-418419', location='us-central1')
